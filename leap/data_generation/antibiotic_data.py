...
def generate_antibiotic_data(
    ...
    if return_type == "csv":
        ...
        config["antibiotic_exposure"]["parameters"]["βyear"] = model_abx.params["timepoint"]
        ...
        config["antibiotic_exposure"]["parameters"]["β2005_year"] = model_abx.params["heaviside(timepoint, 2005):timepoint"]
