...
1. `leap/processed_data/{time_interval_tag}/birth/birth_estimate.csv`
2. `leap/processed_data/{time_interval_tag}/birth/initial_pop_distribution_prop.csv`
...
1. `leap/processed_data/{time_interval_tag}/life_table.csv`
...
1. `leap/processed_data/{time_interval_tag}/life_table.csv` (generated by `death_data.py`)
2. `leap/processed_data/{time_interval_tag}/birth/initial_pop_distribution_prop.csv` (generated by `birth_data.py`)
...
This will update the file `leap/processed_data/{time_interval_tag}/asthma_occurrence_predictions.csv`. This file
...
This will update the file `leap/processed_data/{time_interval_tag}/asthma_occurrence_correction.csv`. This file
...
This will update the file `leap/processed_data/{time_interval_tag}/asthma_occurrence_correction.csv` as described
above, and will also update `leap/processed_data/{time_interval_tag}/occurrence_calibration_parameters.json`:
