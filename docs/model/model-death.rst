...
into a single processed file, with one file per time interval:

- `leap/processed_data/time_delta_365/life_table.csv
  <https://github.com/resplab/leap/blob/main/leap/processed_data/time_delta_365/life_table.csv>`_ (annual)
- `leap/processed_data/time_delta_30/life_table.csv
  <https://github.com/resplab/leap/blob/main/leap/processed_data/time_delta_30/life_table.csv>`_ (monthly)
